    ...
    return (
        <div className="flex flex-col justify-center items-center min-h-screen gap-5 bg-[#0a1b34]">
            <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-300 text-center ">Crea tu cuenta para comenzar</p>
            </div>
            {loading && 
            <div role="status">
            ...
            <div className="md:w-1/3 w-3/4 mx-auto flex flex-col gap-4 bg-white p-4 rounded-lg shadow-xl justify-center items-center">
                <div className="flex flex-col gap-2">
                    ...
                    <p className="text-gray-600 text-center">Únete a nuestra comunidad</p>
                </div>
                <form className="flex flex-col gap-4 w-[90%]">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="relative">
                            ...
                            <input 
                                ...
                                className="border border-gray-300 rounded-lg p-2 pl-10 pr-10 w-full focus:outline-none focus:ring-2 focus:ring-blue-500"
                            />
                            <button
                                type="button"
                    ...
                    <button type="button" onClick={handleSubmit} className="bg-[#0a1b34] cursor-pointer  mx-auto rounded-lg py-2 px-12 focus:outline-none focus:ring-2 focus:ring-blue-500 hover:bg-red-800 text-white font-semibold">Crear Cuenta</button>
                </form>
                ...
                <div className="flex flex-col md:flex-row md:gap-2 justify-center  text-center">
                    ...
                    <a onClick={() => navigate('/login')} className="text-blue-500 hover:underline cursor-pointer">Inicia sesión aquí</a>
                </div>
            </div>
